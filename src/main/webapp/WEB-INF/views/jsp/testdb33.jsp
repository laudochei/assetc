...
<%
   ...
   try {
        ...
        stmt.executeUpdate("INSERT INTO location (locationno, locationid, parentname, description, longdescription, parentcraft, craft, equipmenttype, failurecode, systemstatus, userstatus, criticality, co, sud, planningplant, maintenanceplant, physicallocation, manufacturer, partnum, modelnum, serialnum, customfield) VALUES (108, 'ID80-006-BP-OLS-PEI-XII-10', 'ID80-ID80-TLSE', 'PPNG, HZDOUS SOLID WASTE TREATMENT', 'PPNG, HZDOUS SOLID WASTE TREATMENT', 'IMP', 'INSP', 'type1', 'FA_PEG', 'CRTE', '00', 'C', '2016-05-01', '2016-05-01', '00000', 'ID80', 'Aberdeen', 'FACEBOOK', '00000', 'eLLK92036-36', '00000', '00000')");
        stmt.executeUpdate("INSERT INTO asset (assetno, assetid, locationid, description, longdescription, equipmenttype, failurecode, manufacturer, partnum, modelnum, serialnum, physicallocation, customfield) VALUES (40, '100000000020', 'ID80-006-BP-OLS-PEI-XII-10', 'PPNG, HZDOUS SOLID WASTE TREATMENT', 'PPNG, HZDOUS SOLID WASTE TREATMENT', 'type1', 'FA_PEG', 'PHILIPSON', '00000', 'eLLK92036-36', '00000', 'London', '00000')");
