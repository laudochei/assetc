...
<body>
<spring:url value="/locations/locationlist" var="urlHome" />
...
<div class="container">
	...
	<spring:url value="/locations" var="locationActionUrl" />

	<form:form class="form-horizontal" method="post" modelAttribute="locationForm" action="${locationActionUrl}">
		...
		<spring:bind path="parent">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:input path="parent" class="form-control" id="parent" placeholder="parent" />
					<form:errors path="parent" class="control-label" />
				</div>
			</div>
		</spring:bind>
		...
		<spring:bind path="desc">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				<label class="col-sm-2 control-label">Parent</label>
				<div class="col-sm-10">
					<form:input path="desc" class="form-control" id="desc" placeholder="desc" />
					<form:errors path="desc" class="control-label" />
				</div>
			</div>
		</spring:bind>
		...
		<spring:bind path="longdesc">
			<div class="form-group ${status.error ? 'has-error' : ''}">
				...
				<div class="col-sm-10">
					<form:textarea path="longdesc" rows="5" class="form-control" id="longdesc" placeholder="longdesc" />
					<form:errors path="longdesc" class="control-label" />
				</div>
			</div>
		</spring:bind>
